fileN = "Module_1_RUN_281117_1640"
plotset = "LGSCA0"
...
set title sprintf("%s !\nShow next plot in 5 sec!",Title_avg)
...
set title sprintf("%s !\nShow next plot in 5 sec!",Title_noise)
plot data using 1:2:4 with circles lc palette, \
     data using 1:2:4 with labels font ",10", \
     frame with lines lw 2 lc "black"

pause 5
set title sprintf("%s !\nExit gnuplot in 5 sec!",Title_chinfo)
plot data using 1:2:4 with circles lc palette, \
     data using 1:2:(sprintf("(%i, %i)", $5, $6)) with labels font ",9" ,\
     frame with lines lw 2 lc "black"
pause 5
